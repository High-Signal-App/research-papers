    ...
    <div className="space-y-4">
      ...
      >
        ...
        <button
          ...
          className="px-5 py-3 rounded-lg bg-primary text-primary-foreground text-sm font-medium disabled:opacity-50 hover:opacity-90 transition-opacity"
        >
        ...
        <div className="space-y-2">
          {results.map((r) => (
            ...
            >
              ...
              <div className="text-xs text-muted-foreground line-clamp-2">{r.abstract_preview}</div>
            </a>
          ))}
        </div>
      )}
